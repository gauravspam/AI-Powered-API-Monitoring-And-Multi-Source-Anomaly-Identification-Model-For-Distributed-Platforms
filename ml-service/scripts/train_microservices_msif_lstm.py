...
Train MSIF-LSTM model on Microservices (Social Network) dataset
...
# Add parent directory to path BEFORE importing tensorflow
...
try:
    ...
    from msif_lstm_model import build_msif_lstm_model
...
def prepare_training_data(df):
    ...
    feature_cols = [col for col in df.columns if col not in ['label', 'timestamp', 'time']]

    

    # Take exactly 21 features
