...
def load_data(data_path):
    ...
    feature_cols = ["response_time", "status_code", "request_count", "error_rate", "cpu_usage", "memory_usage", "network_io", "disk_io", "hour_of_day", "day_of_week"]
