...
Standalone PLE-GRU Training Script for Microservices Dataset
...
CONFIG = {
    ...
    'gru_units': [64, 32],  # PLE-GRU architecture
...
def build_ple_gru_model(input_shape, learning_rate=0.001):

    """Build PLE-GRU model architecture"""
...
def load_microservices_data():
    ...
    if 'is_anomaly_max' in df.columns:
        ...
        print(f"Label distribution:\n{df['is_anomaly_max'].value_counts()}")
...
def prepare_training_data(df):
    ...
    scaler_path = os.path.join(CONFIG['model_save_dir'], 'ple_gru_scaler.pkl')
...
def train_model(X_train, y_train, X_val, y_val):
    ...
    model_path = os.path.join(CONFIG['model_save_dir'], 'ple_gru_model.keras')
...
def save_metadata(metrics):
    ...
    metadata_path = os.path.join(CONFIG['model_save_dir'], 'ple_gru_metadata.json')
...
def main():
    ...
    print("MICROSERVICES PLE-GRU TRAINING")
    ...
    print(f"  • Model:    {CONFIG['model_save_dir']}/ple_gru_model.keras")

    print(f"  • Scaler:   {CONFIG['model_save_dir']}/ple_gru_scaler.pkl")

    print(f"  • Metadata: {CONFIG['model_save_dir']}/ple_gru_metadata.json")
